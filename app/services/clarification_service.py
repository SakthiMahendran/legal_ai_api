import os
from legal_ai_api.clarification.graphSearch import LegalSearchGraph
from legal_ai_api.clarification.summarize import LegalSummarizer
...
class ClarificationService:
    ...
    def summarize_results(self, search_results: dict, summary_type: str = "comprehensive") -> dict:
